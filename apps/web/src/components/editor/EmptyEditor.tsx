      ...
      <div className="empty-editor-card">
        ...
        <div className="empty-editor-shortcuts">
          <div className="shortcut-item">
            <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>P</kbd> 快速打开
          </div>
          <div className="shortcut-item">
            <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>F</kbd> 全文搜索
          </div>
          <div className="shortcut-item">
            <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>S</kbd> 保存笔记
          </div>
          <div className="shortcut-item">
            <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>B</kbd> 切换侧边栏
          </div>
          <div className="shortcut-item">
            <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>,</kbd> 设置
          </div>
        </div>
      </div>
    </div>
